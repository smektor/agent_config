...
- Recommended Next Session: name the most appropriate agent type for the follow-up work (e.g. Backend Architect, Security Engineer, Code Reviewer — pick the one that fits the next task).
